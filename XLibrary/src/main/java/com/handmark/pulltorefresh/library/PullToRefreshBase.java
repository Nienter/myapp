...
//		//activityGroup情况下，下方键盘弹起，会有跳动
//		if(mFirstSizeChanged){
//			mFirstSizeChanged = false;
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				...
				case CUSTOM:
					return XUIProvider.getInstance().createCustomLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
	}
