...
public class EventCode{
	 ...
	 * @param List(RecentChat)
     */
	public static final int DB_SaveAllRecentChat		= ++CODE_INC;
	
	/**
	 * @param List(RecentChat)
	 * @param Map(String,RecentChat)(unreads)
     */
	public static final int DB_ReplaceAllRecentChat		= ++CODE_INC;
	...
	public static final int DB_ClearRecentChatUnread 	= ++CODE_INC;
