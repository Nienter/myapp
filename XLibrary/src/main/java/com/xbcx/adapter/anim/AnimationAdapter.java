...
public abstract class AnimationAdapter extends BaseAdapterDecorator {
    ...
    private boolean	mShouldAlpha = true;
    ...
    public void setShouldAlpha(final boolean shouldAlpha){
    	mShouldAlpha = shouldAlpha;
    }
    ...
    private void animateView(final ViewGroup parent, final View view) {
        ...
        Animator alphaAnimator = ObjectAnimator.ofFloat(view, ALPHA, mShouldAlpha ? 0 : 1, 1);
