...
public class TimePicker extends FrameLayout {
    ...
    public void setMaxHour(int maxHour){
    	mMaxHour = maxHour;
    	if(mHourSpinner.getValue() > maxHour){
    		mHourSpinner.setValue(maxHour);
    	}
    	updateHourControl();
    }
    ...
    public void setMaxMinute(int maxMinute){
    	...
    	if(mMinuteSpinner.getValue() > maxMinute){
    		mMinuteSpinner.setValue(maxMinute);
    	}
    ...
    public void setMinMinute(int minMinute){
    	...
    	if(mMinuteSpinner.getValue() < minMinute){
    ...
    private void updateHourControl() {
        if (is24HourView()) {
        	mHourSpinner.setMinValue(mMinHour);
        	mHourSpinner.setMaxValue(mMaxHour > mMinHour ? mMaxHour : 23);
            mHourSpinner.setFormatter(NumberPicker.getTwoDigitFormatter());
        } else {
        	mHourSpinner.setMinValue(mMinHour > 0 ? mMinHour : 1);
        	mHourSpinner.setMaxValue(mMaxHour > mMinHour ? mMaxHour : 12);
